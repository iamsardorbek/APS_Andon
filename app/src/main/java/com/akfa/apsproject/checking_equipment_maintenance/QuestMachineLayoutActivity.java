...
public class QuestMachineLayoutActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        initInstances();
        final DatabaseReference equipmentLayoutRef = FirebaseDatabase.getInstance().getReference(getString(R.string.shops_ref) + "/" + shopNo + "/Equipment_lines/" + equipmentNo + "/layout_start_pic_name");
