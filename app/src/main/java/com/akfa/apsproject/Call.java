...
public class Call {
    ...
    public Call(){};
    public Call(String date_called, String time_called, String called_by, String who_is_needed_position, int station_no, String equipment_name, String shop_name, boolean complete, String problem_key){
    ...
    public Call(String date_called, String time_called, String called_by, String who_is_needed_position, int station_no, String equipment_name, String shop_name, boolean complete){
        this.date_called = date_called;
        this.time_called = time_called;
        this.called_by = called_by;
        this.who_is_needed_position = who_is_needed_position;
